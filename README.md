# AgrinhoYuri2026
Para a criação e estruturação do código deste projeto, foi utilizada a assistência da Inteligência Artificial Gemini. A decisão de usar a IA teve como objetivo otimizar a organização lógica do programa, garantir uma interface limpa para o usuário e validar as estruturas de dados que armazenam as informações sobre os solos brasileiros. O Gemini atuou como um assistente de programação, ajudando a traduzir as ideias pedagógicas e os dados geográficos em linhas de código eficientes, enquanto a supervisão, a escolha dos conteúdos sobre as cinco regiões do Brasil e a lógica do quiz final foram totalmente coordenadas por mim.
